...
0.4.1 已于 2026-09-05 提交，等待人工审核。审核通过前 Marketplace 搜索不到该插件。

0.4.0 曾于同日提交后撤回：三个 IDE 的 Verifier 结论均为 Compatible，但延时一旦调到
500 ms 以上面板完全不出现，见 CHANGELOG 的 0.4.1 条目。
